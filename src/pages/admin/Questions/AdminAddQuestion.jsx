...
export default function AdminAddQuestion() {
  ...
  const createQuestion = async (data) => {
    let questionAddResponse = null;
    try {
      questionAddResponse = await QuestionService.addQuestion(data);
      ...
      formRef.current.questionDesc.value = "";
      formRef.current.option1.value = "";
      formRef.current.option2.value = "";
      formRef.current.option3.value = "";
      formRef.current.option4.value = "";
      setAnswer("");
    }
  };
    ...
    <React.Fragment>
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3, marginTop: "20px" }}>
          <div
            className="container container-card rounded"
          ...
          >
            ...
            <div className="row p-2">
              <form
                ref={formRef}
                onSubmit={(event) => submitQuestionForm(event)}
              >
                <div className="mb-3">
